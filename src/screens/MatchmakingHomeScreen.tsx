    ...
    <ScrollView style={commonStyles.container}>
      ...
      <View style={commonStyles.section}>
        ...
        <TouchableOpacity
          style={[
            commonStyles.button,
            !activitySearch ? commonStyles.disabledButton : null,
          ]}
        ...
        <Text style={commonStyles.caption}>
          Examples: "Semi-serious bowling with drinks", "Casual people to play
          football with on Sundays"
        </Text>
      </View>
      ...
      <View style={commonStyles.section}>
        ...
        <TouchableOpacity
          style={[
            commonStyles.button,
            !eventSearch ? commonStyles.disabledButton : null,
          ]}
        ...
        <Text style={commonStyles.caption}>
          Examples: "Taylor Swift concert in London March 8th", "Gala music
          festival"
        </Text>
      </View>
    </ScrollView>
