-- ============================================
-- SHARE URL → custom domain (grappleapp.co.uk)
-- The web app moved from the Vercel preview host
--   group-matchmaker-app-web.vercel.app
-- to the custom domain
--   grappleapp.co.uk
-- (the old host is kept as a redirect, so existing links still resolve).
--
-- This re-creates get_event_room_messages_v2 with the new share URL in the
-- synthesized welcome message. Everything else is unchanged from
-- 20260415000006_fix_share_url.sql.
-- ============================================
            ...
            FROM (
                ...
                SELECT
                    ...
                    CONCAT(
                        ...
                        E'\n\n', 'Share this event: https://grappleapp.co.uk/event/', v_event_room.id,
